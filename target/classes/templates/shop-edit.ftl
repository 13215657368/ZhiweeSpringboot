	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   value="${shop.num}"  readonly id="num" name="num">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>店铺名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  value="${shop.shopname}"  id="shopname" name="shopname">
			</div>
		</div>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button  id="sub"   onClick="shop_save_submit();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i>更新</button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function shop_save_submit() {
        ...
        if(null==num||""==num.trim()||null==shopname||""==shopname.trim()){
            layer.msg("信息不完整，请检查",{
                icon:2,
                time:1500,
            })
