...
<#--<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">admin</a>
            ...
            <span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 专卖店 <span class="c-gray en">&gt;</span> 专卖店管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="Hui-article">
        <article class="cl pd-20">

            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l"><#--<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>-->
                    <a class="btn btn-primary radius" onclick="picture_add('添加图片','${ctx}/shops/addPage')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加店铺</a></span>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <td>${item_index+1}</td>
                        <td>${item.num}</td>
                        <td class="text-l"><a class="maincolor" href="javascript:;"  onClick="pictureList_edit('图库列表','${ctx}/shops/picture/show?shopid=${item.num}')" style="display: block; text-align: center;">${item.shopname}</a></td>
                        <td class="td-manage"><a style="text-decoration:none" class="ml-5" onClick="picture_edit('图库编辑','${ctx}/shops/detail?id=${item.id}')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="shop_del(this,'${item.num}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                    </tr>
                    </#list>
                    </tbody>
                </table>
...
<script type="text/javascript">
    ...
    /*图片-删除*/
    function shop_del(obj,num){
        layer.confirm('确认要删除吗？',function(index) {
            $.ajax({
                type: 'POST',
                url: '${ctx}/shops/delete',
                data: {
                    num: num
                },
                dataType: 'json',
