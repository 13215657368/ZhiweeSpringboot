...
<link href="${ctx}/static/static/h-ui.admin/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
			...
			<li class="item">
				...
				<#--	<input class="checkbox" name="" type="checkbox" value="">-->
					<div class="picbox">
					   ...
					   <#-- <a onclick="imgdel('${item.id}','${item.url}')" class="btn btn-danger ">删除</a>-->
                        <#--<button ></button>-->
					</div>
				</div>
			</li>
...
function imgdel(id,url) {
    layer.confirm('确认要删除吗？',function(index){

    $.ajax({
        type: 'POST',
        url:"${ctx}/shops/img/delete",
        data:{
            id:id,
            url:url
        },
