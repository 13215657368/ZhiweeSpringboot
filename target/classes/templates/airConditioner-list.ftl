...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 代理商 <span class="c-gray en">&gt;</span>中央空调<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<article class="cl pd-20">
			...
			<#--<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">-->
                ...
                <div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l">
				<a href="javascript:;" onclick="del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<a href="javascript:;" onclick="member_add('添加代理商','${ctx}/business/air/addPage')" class="btn btn-primary radius">
				...
				<div  id="showTag" style="display: none;height: 5%"><MARQUEE  scrollAmount=2 scrollDelay=150 direction=right height=40><h4 style="color: #2e8ded;">正在导入,请稍后</h4></marquee></div>
			</form>
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <#list  result.result as item>
						<tr class="text-c">
                            ...
                            <td>${item.address}</td>
                            <td>
                                <#if item.isShop == 1>是</#if>
                                <#if item.isShop == 2>否</#if>
                            </td>
							<td class="td-manage">
								<a title="编辑" href="javascript:;" onclick="member_edit('编辑','${ctx}/business/air/editPage?id=${item.id}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
<script type="text/javascript">
	function Export(){
		window.location.href="${ctx}/business/AirExport"
	}
$(function(){
...
function del() {
    ...
    $.ajax({
        type: 'POST',
        url: '${ctx}/business/air/BatchDelete',
        data:{
            ids: selectList
        },
        dataType: 'json',
