	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="authNum" name="authNum">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<#--	<select name="type" id="type" class="select">
					&lt;#&ndash;<option  value="0">请选择类别</option>&ndash;&gt;
					&lt;#&ndash;<option   value="1">格力中央空调</option>&ndash;&gt;
					<option   value="2" selected>格力电器</option>
				</select>-->
				</span>
            </div>
        </div>
		...
		<div class="row cl"   id="showShopNum" style="display: none">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>专卖店号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  id="shopNum" name="shopNum">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="represent" id="represent">
			</div>
		</div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  name="tel" id="tel">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="level" id="level">
					...
					<option value="7">专卖店授权（不评星）</option>
				</select>
				</span> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  name="hotline" id="hotline">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  name="remark" id="remark">
            </div>
        </div>
