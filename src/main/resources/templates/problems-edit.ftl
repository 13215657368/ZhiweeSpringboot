    ...
    <form class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"><#--<#if (param.id)?exists>updateGoods<#else>addGoods</#if>-->
                <input type="text" class="input-text"  value="${problem.title}" id="title" name="title"  >
            </div>
        </div>
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                if(result!=null){
                    ...
                    $('#remark1').append('   <a style="text-decoration:none" class="ml-5"  id="delImg1" onClick="img_del()" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>');
