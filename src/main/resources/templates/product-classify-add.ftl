	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入" id="name" name="name">
			</div>
		</div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                &nbsp;&nbsp; &nbsp;
                <span>
                <select  style="width: 40%" name="type" id="second"   class="select">
...
<script type="text/javascript">
    ...
    function getSecond(id){
        var   htmlStr ="<option value='0'>请选二级分类</option>";
        $.ajax({
            type:'POST',
