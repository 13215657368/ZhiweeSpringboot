...
<article class="cl pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                是：<input type="radio"  value="1"  name="isShop" id="isShop">
                否：<input type="radio"  value="2"  name="isShop" id="isShop">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  name="area" id="area">
            </div>
        </div>
