        ...
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l"><#--<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>-->
                    <a class="btn btn-primary radius" onclick="picture_add('添加图片','${ctx}/productChart/addPage')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></span>
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                   ...
                   <#list  list.result as item>
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                            <a style="text-decoration:none" class="ml-5" onClick="img_del(this,'${item.url}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
