...
<!--[if lt IE 9]>
<script type="text/javascript" src="${ctx}/static/ib/html5.js"></script>
	...
	<form action="" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text"  readonly class="input-text" value="${user.username}" placeholder="" id="username" name="username">
			</div>
		</div>
		<#--<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="sex" type="radio" value="1" id="sex-1" <#if user.sex==1>checked</#if> >
					<label for="sex-1" >男</label>
				</div>
				<div class="radio-box">
					<input type="radio" value="2" id="sex-2" name="sex" <#if user.sex==2>checked</#if> >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="${user.email}" class="input-text" placeholder="@" name="email" id="email">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
				<select class="select" name="role" id="role" size="1">
					<option value="0" <#if user.role==0>selected</#if> >请选择角色</option>
					<option value="1" <#if user.role==1>selected</#if> >超级管理员</option>
					<option value="2" <#if user.role==2>selected</#if> >普通管理员</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                <input type="text"  <#if user.remark ??>value="${user.remark}"</#if> class="input-text"  placeholder="请说点什么，备注该管理员职能"  name="remark" id="remark">
			</div>
		</div>
		<div class="row cl">
