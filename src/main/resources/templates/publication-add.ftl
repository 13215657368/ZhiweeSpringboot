    ...
    (function( $ ){
        ...
        $(function() {
            ...
            uploader.on('uploadSuccess', function(file,response) {
                ...
                $('#remark1').append('<a style="text-decoration:none" id="del'+i+'" class="ml-5"   onClick="img_del2(\''+ i + '\',\''+ response.fileUrl + '\')"  href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>');
                i+=1;
                $("#imgId").val(i);
                var  pagenum  = $("#pagenum option:selected").val();
                if(pagenum==0){
            ...
            success:function (result) {
                ...
                if(result.fileUrl!=null){
                 ...
                 //   $('#info2').html("当前进度:100%");
                    ...
                    $('#remark2').append('<a style="text-decoration:none" class="ml-5"  id="delImg2" onClick="img_del()" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>');
                }
                // console.log(result);
