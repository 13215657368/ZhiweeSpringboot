...
<#--				<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>-->
				<a class="btn btn-primary radius" data-title="常见问题"  onClick="article_add()" href="Javascript:;"><i class="Hui-iconfont">&#xe600;</i> 问题新增</a>
				</span>
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <td class="f-14 td-manage">
                        <a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑','${ctx}/problems/editPage?id='+${item.id})" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
