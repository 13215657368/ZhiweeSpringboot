...
<div class="page-container">
	...
	<form class="form form-horizontal" id="form-article-add">
		<#--<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>店铺编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"    onblur="checkNum(this.value)"  id="num" name="num">
			</div>
		</div>-->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">图片链接：</label>
			<div class="formControls col-xs-8 col-sm-9">
               <#-- <select  name="clickUrl" id="clickUrl"  class="select">
                    <option value="">请选择</option>
                    <option value="./pages/search/search-dq.html">格力电器查询页</option>
                    <option value="./pages/search/search-kt.html">中央空调查询页</option>
                </select>-->
                <input type="clickUrl" class="input-text"  placeholder="例如./pages/search/search-dq.html,此项非必填项，可填写可不填写"  id="clickUrl" name="clickUrl"  >
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button  id="sub"  onClick="infoSubmit();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 提交</button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function imgInsert() {
    //    var   clickUrl =  $("#clickUrl option:selected").val();
    ...
    $(function() {
       ...
       /*上传成功之后回调函数*/
        uploader.on('uploadSuccess', function(file,response) {
            //alert(JSON.stringify(response).file);
         ...
         //   $('#remark1').append("<a style='text-decoration:none' class='ml-5'  id='delImg' onClick='img_del(\""+ response.fileUrl + "\")'  href='javascript:;' title='删除'><i class='Hui-iconfont'>&#xe6e2;</i></a>");
                 i+=1;
                 $("#imgId").val(i);
            imgInsert();
