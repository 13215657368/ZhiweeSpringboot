...
<body>
<input  type="hidden"  id="titleImgUrl">
    ...
    <form class="form form-horizontal" id="form-picture-add" enctype="multipart/form-data" >
      <#--  <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"   onblur="checkNum(this.value)"  id="acid" name="id">
            </div>
        </div>-->
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="type" id="type" class="select">
					...
					<option   value="1">员工风采</option>
					<option   value="2">长久风采</option>
				</select>
				</span>
            </div>
        </div>
     ...
     <#--   <label class="form-label col-xs-4 col-sm-2">精彩瞬间图：</label>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button onClick="artive_save_submit();" type="button" class="btn btn-primary radius" ><i class="Hui-iconfont">&#xe632;</i> 提交</button>
            </div>
        </div>
    ...
    function checkNum(id) {
        $.ajax({
            ...
            success:function(result) {
                if(result.code==400){
                    layer.msg("活动编号已存在，请请重新选择",{
                        icon:2,
                        time:1500,
                    })
                    //alert("活动编号已存在，请请重新选择");
                }
            }
        })
    }
